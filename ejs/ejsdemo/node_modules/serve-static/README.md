...
// Serve up views/ftp folder
var serve = serveStatic('views/ftp', { 'index': ['index.html', 'index.htm'] })
...
// Serve up views/ftp folder
var serve = serveStatic('views/ftp', {
  'index': false,
...
app.use(serveStatic('views/ftp', { 'index': ['default.html', 'default.htm'] }))
app.listen(3000)
```
...
app.use(serveStatic(path.join(__dirname, 'views-optimized')))
...
function setCustomCacheControl (res, path) {
  if (serveStatic.mime.lookup(path) === 'text/html') {
    ...
    res.setHeader('Cache-Control', 'views, max-age=0')
  }
}
```
